        ...
        <Row className="mt-4 col-12 ml-1 estilo">
          <Col xs={12} md={4}>
            <InputGroup className="mb-3">
              <FormControl type="text" placeholder="Buscar Auto"></FormControl>
              <InputGroup.Append>
        ...
        <Row className="mt-4 col-12 ml-1">
          ...
          <Col xs={6} md={8} className="col-8">
            <Form className="properties-pagar">
              ...
              <Form.Group>
                <Button className="properties-button" variant="success">
                  Pagar
                </Button>
              </Form.Group>
            </Form>
